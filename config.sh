...
if [ ! -z "$POSTGRES_MAX_LOCKS_PER_TRANSACTION" ]; then echo "max_locks_per_transaction = $POSTGRES_MAX_LOCKS_PER_TRANSACTION" >> /etc/postgresql/16/main/conf.d/postgres-tuning.conf; fi
